...
-Added unique character count to encourage variety 
-Added detection of spaces or unusual characters

v1.2.0 - December 1, 2025

-Added live web extension mode 
-Can be turned on/off 
-When on, whatever you type will be checked as a password
